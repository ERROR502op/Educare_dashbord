...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _storeStudentData() async {
    ...
    stdname = pref.getString("StdName");
    batch = pref.getString("Batch_id");
    Id = pref.getInt("Id");
  }
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () async{
                          var url ="https://masyseducare.com/App_Pages/NewDoubt_Student.aspx?uid=${Id}";
