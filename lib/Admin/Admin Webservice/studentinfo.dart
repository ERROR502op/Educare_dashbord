...
List<StudentInfo> studentInfoFromJson(String str) => List<StudentInfo>.from(json.decode(str).map((x) => StudentInfo.fromJson(x)));

String studentInfoToJson(List<StudentInfo> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
